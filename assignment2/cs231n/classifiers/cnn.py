...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        #get all relevant sizes (including padding and pooling)
        (C, H, W) = input_dim
        ...
        size_post_conv_pool = int(num_filters*H*W/4)
        self.params['W2'] = weight_scale * np.random.randn(size_post_conv_pool,hidden_dim)
